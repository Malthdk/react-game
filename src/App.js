...
Auth0.configure({
  domain: 'holledig.eu.auth0.com',
  clientID: 'oS8zhMotmj0LndxHXGVxCQpsD08u4B17',
  redirectUri: 'http://localhost:3000/', // Change this when uploading to domain
  responseType: 'token id_token',
  scope: 'openid profile manage:points',
  audience: 'http://malteholledig.dk/react-game'
});
